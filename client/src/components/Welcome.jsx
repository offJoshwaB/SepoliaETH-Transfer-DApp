...
// import {transactionHash} from '../context/TransactionContext';
...
const Welcome = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // console.log("Sending to address:", addressTo);
        // console.log("typeof addressTo:", typeof addressTo); // should be "string"
        // console.log("addressTo value:", addressTo);
        // console.log(contractABI);
        // console.log("Contract address:", contractAddress);
        // console.log("ABI method check:", contractABI);
        ...
        <div className = "flex w-full justify-center items-center">
            <div className = " flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4 ">
                ...
                <div className=" flex flex-col flex-1 items-center jusitfy-start w-full mf:mt-0 mt-10 ">
                    ...
                    <div className = " p-3 justify-end items-start flex-xol rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorpism ">
                    ...
                    <div className="p-5 sm:w-96 w-full flex-col justify-start ietms-center blue-glassmorphism">
